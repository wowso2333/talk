...
export const getSignedUrl = async (file) => {
    ...
    try {
        const response = await axios.post(`${API_BASE_URL}/cloud/uploadImg`, formData, {
            headers: {
...
export async function deleteImage(imageUrl) {
    try {
        const response = await axios.delete(`${API_BASE_URL}/cloud/deleteImg`, {
            params: {
                imageUrl: imageUrl
            }
        });
...
export async function getUserInformation(username){
    try{
        const response = await axios.get(`${API_BASE_URL}/article/getUerInformation`,{
            params:{
                username : username
            }
        });
...
export async function addArticle(article){
    try{
        const response = await axios.post(`${API_BASE_URL}/article/add`, article)
        return response.data;
...
export async function addFavoriteBoard(userId, boardId){
    try{
        const response = await axios.post(`${API_BASE_URL}/user/addFavoriteBoard`, { 
            userId : userId,  
            boardId : boardId
        })
        return response.data
...
export async function removeFavoriteBoard(userId, boardId){
    try{
        const response = await axios.delete(`${API_BASE_URL}/user/removeFavoriteBoard`, {
            params: {
                userId: userId,
                boardId: boardId
            }
...
export async function getPopularArticle(){
    try{
        const response = await axios.get(`${API_BASE_URL}/article/popular`)
        return response.data
    }catch(error){
...
export async function getLatestArticle(){
    try{
        const response = await axios.get(`${API_BASE_URL}/article/latest`)
        return response.data
    }catch(error){
        console.log('Failed to getPopularArticle:', error)
        throw error
...
export async function getFavoriteBoardId(userId){
    try{
        const response = await axios.get(`${API_BASE_URL}/user/getFavoriteBoardId`, {
          params : {
            userId : userId
        }})
...
export async function getFavBoardArticles(boardIds) {
    try {
        const response = await axios.get(`${API_BASE_URL}/article/getFavBoardArticles`, {
            params: { 
                boardIds: boardIds
            },
...
export async function getSpecifyBoardArticle(boardName) {
    try {
        const response = await axios.get(`${API_BASE_URL}/article/getSpecifyBoard/${boardName}`);
        return response.data;
    } catch (error) {
...
export async function getArticleById(articleId) {
    try {
        const response = await axios.get(`${API_BASE_URL}/article/getArticleById/${articleId}`);
        return response.data;
    } catch (error) {
...
export async function incrementArticleLove(articleId) {
    try {
        const response = await axios.post(`${API_BASE_URL}/article/incrementLove/${articleId}`);
        return response.data;
    } catch (error) {
...
export async function decrementArticleLove(articleId) {
    try {
        const response = await axios.post(`${API_BASE_URL}/article/decrementLove/${articleId}`);
        return response.data;
    } catch (error) {
        console.error('Failed to incrementArticleLove:', error);
        throw error;
...
export async function addMessage(message) {
    try {
        const response = await axios.post(`${API_BASE_URL}/message/addMessage`, message
        );
        return response.data;
    } catch (error) {
...
export async function incrementMessageLove(messageId) {
    try {
        const response = await axios.post(`${API_BASE_URL}/message/incrementMessageLove/${messageId}`);
        return response.data;
    } catch (error) {
...
export async function decrementMessageLove(messageId) {
    try {
        const response = await axios.post(`${API_BASE_URL}/message/decrementMessageLove/${messageId}`);
        return response.data;
    } catch (error) {
        console.error('Failed to incrementMessageLove:', error);
        throw error;
...
export async function getMessagesByArticleId(articleId) {
    try {
        const response = await axios.get(`${API_BASE_URL}/message/getMessagesByArticleId/${articleId}`);
        return response.data;
    } catch (error) {
...
export async function getRecommendBoardsInformation() {
    try {
        const response = await axios.get(`${API_BASE_URL}/article/getRecommendBoards`);
        return response.data;
    } catch (error) {
...
export async function getAllBoardsInformation() {
    try {
        const response = await axios.get(`${API_BASE_URL}/article/getAllBoards`);
        return response.data;
    } catch (error) {
        console.log('Failed to getRecommendBoards:', error);
        throw error;
...
export async function getAvatar(userId) {
    try {
        const response = await axios.get(`${API_BASE_URL}/article/getAvatarUrl`,{
            params: { 
                userId: userId
        }
        });
...
export async function getArticlesByUserId(userId) {
    try {
        const response = await axios.get(`${API_BASE_URL}/article/getArticlesByUserId`,{
            params: { 
                userId: userId
        }
        });
...
export async function deleteArticle(articleId) {
    try {
        const response = await axios.delete(`${API_BASE_URL}/article/delete`, {
            params: {
                articleId: articleId
            }
        });
...
export async function getFavoriteBoardInfo(userId) {
    try {
        const response = await axios.get(`${API_BASE_URL}/user/getFavoriteBoardInfo`,{
            params: { 
                userId: userId
        }
        });
...
export async function deleteAccount(userId) {
    try {
        const response = await axios.delete(`${API_BASE_URL}/user/deleteAccount`, {
            params: {
                userId: userId
            }
        });
...
export async function updateArticle(article){
    try{
        const response = await axios.post(`${API_BASE_URL}/article/edit`, article)
        return response.data
    }catch(error){
...
export async function suggestTitles(keyword) {
    try {
        const response = await axios.get(`${API_BASE_URL}/article/suggest`, {
            params: { keyword }
        });
...
export async function searchKeyWord(keyword) {
    try {
      const response = await axios.get(`${API_BASE_URL}/article/search`, {
        params: { keyword }
      });
      return response.data;
    } catch (error) {
...
export async function donate(articleId = 0, amount) {
  try {
    const res = await axios.post(`${API_BASE_URL}/donate/create`, null, {
